...
export const SEED_META: SeedMeta[] = [
  ...
  { registration: "F-GZNQ", family: "777", operator: "Air France" },
  { registration: "F-GZNT", family: "777", operator: "Air France" },
  { registration: "A6-EOA", family: "a380", operator: "Emirates Airline" },
  { registration: "A6-EOU", family: "a380", operator: "Emirates Airline" },
  { registration: "G-BYGA", family: "747", operator: "" },
  { registration: "G-CIVY", family: "747", operator: "" },
  { registration: "D-AIGA", family: "a340", operator: "" },
  { registration: "VH-OQB", family: "a380", operator: "Qantas" },
  { registration: "9V-SKA", family: "a380", operator: "" },
  { registration: "JA789A", family: "777", operator: "" },
  { registration: "HL7418", family: "747", operator: "" },
  { registration: "TC-JJP", family: "777", operator: "Turkish Airlines" },
  { registration: "A7-ALZ", family: "a350", operator: "Qatar Airways" },
  { registration: "PH-BVA", family: "777", operator: "KLM Royal Dutch Airlines" },
  { registration: "HB-JNB", family: "777", operator: "Swiss International Air Lines" },
  { registration: "OE-LPE", family: "777", operator: "Austrian Airlines" },
  { registration: "OH-LWB", family: "a350", operator: "Finnair" },
  { registration: "SP-LRB", family: "787", operator: "LOT Polish Airlines" },
  { registration: "C-FNNQ", family: "777", operator: "Air Canada" },
  { registration: "N171DZ", family: "767", operator: "Delta Air Lines" },
  { registration: "ZK-OKR", family: "777", operator: "Air New Zealand" },
  { registration: "VT-AND", family: "787", operator: "Air India" },
  { registration: "XA-ADG", family: "787", operator: "AeroMexico" },
  { registration: "B-LXM", family: "a350", operator: "Cathay Pacific Airways" },
  { registration: "9M-MAD", family: "a350", operator: "Malaysia Airlines" },
  { registration: "ET-AVT", family: "777", operator: "Ethiopian Cargo" },
  { registration: "A6-BLC", family: "787", operator: "Etihad Airways" },
  { registration: "HS-TQC", family: "787", operator: "Thai Airways International" },
  { registration: "4X-EDC", family: "787", operator: "EL AL" },
  { registration: "A9C-FB", family: "787", operator: "Gulf Air" },
];

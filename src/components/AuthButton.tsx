...
// Lazy load framer-motion uniquement si nécessaire (desktop)
const MotionMenu = dynamic(() => 
  import("framer-motion").then((fm) => ({
    default: ({ children, ...props }: any) => (
      <fm.motion.div {...props}>{children}</fm.motion.div>
    )
  })),
  { ssr: false }
);
...
export default function AuthButton() {
  ...
  useEffect(() => {
    ...
    // Délai sur mobile pour différer l'initialisation Supabase
  ...
  }, [isSupabaseConfigured, supabase, isMobile]);
    ...
    return (
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {/* Menu déroulant */}
          {isMobile ? (
            // Sur mobile, pas d'animation - menu simple
            showMenu && (
              <>
                <div
            ...
            // Sur desktop, utiliser framer-motion
            <AnimatePresence>
              {showMenu && (
                <>
                  <div

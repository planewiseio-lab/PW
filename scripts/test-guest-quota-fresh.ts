...
console.log("🎭 Fresh Guest Quota Test Script");
console.log("=================================");
console.log(`Timestamp: ${new Date().toISOString()}`);
console.log();

async function testGuestQuotaFresh() {
  const baseUrl = "http://localhost:3000";

  console.log("🔍 Testing Guest Quota System with fresh IP...");
  console.log();
  ...
  try {
    const response = await fetch(`${baseUrl}/api/aircraft/lookup`, {
      ...
      headers: {
        ...
        "x-forwarded-for": "192.168.1.200", // Fresh IP
      },
  ...
  console.log();
  console.log("🎉 Fresh Guest Quota Test Complete!");
  console.log();
  console.log("📋 Summary:");
